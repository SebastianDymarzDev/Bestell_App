let allMenus = {
    ...
    'burgerMenuDescriptions': ['Mixed green salad, Tomatoes, Edamame, Mushrooms', 'Beef, Bacon, Dill pickles, Smoked cheese, Ketchup, BBQ souse', 'Beef, Cheese, Tomatoes, Lettuce, Onion', 'Chicken, Cheese, Tomatoes, Lettuce, Onion, Bell pepper'],
    ...
    'pizzaMenuDescriptions': ['Tomato Sauce, Mozzarella', 'Tomato slices, Mozzarella, Chorizo', 'Red onion, Olives, Button Mushrooms, Mozzarella', 'Chicken, Mozzarella, Gorgonzola, Fontina,  Parmigiano Reggiano'],
